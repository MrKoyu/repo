    ...
    try:
        ...
        if 'pairlist' in url:
            ...
            for item in PAIR_LIST:
                the_title = '[COLOR %s][B]. iPair  -  [/B][COLOR %s]%s[/COLOR]' % (COLOR1, COLOR2, item[0].capitalize())
                names.append(the_title)
            selected = xbmcgui.Dialog().select('[COLOR %s]NuMb3r5 - Select Site To Pair Device With[/COLOR]' % COLOR2, names)
    ...
    try:
        ...
        if 'authlist' in url:
            ...
            for item in AUTH_LIST:
                ...
                names.append(the_title)
            selected = xbmcgui.Dialog().select('[COLOR %s]NuMb3r5 - Select Debrid Service To Authorize With[/COLOR]' % COLOR2, names)
