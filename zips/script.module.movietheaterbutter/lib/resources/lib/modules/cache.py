...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'MTB Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.movietheaterbutter')
    ...
    try:
        ...
        oldVersion = '0'
    try:
        curVersion = control.addon('script.module.movietheaterbutter').getAddonInfo('version')
