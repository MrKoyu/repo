...
class podcast:
    ...
    def root(self):
        try:
            self.addDirectoryItem(32629, 'podbay', 'diamond_is_a_cunt.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem(32624, 'podcastOne', 'diamond_is_a_cunt.png', 'DefaultVideoPlaylists.png')
    ...
    def pco_root(self):
        try:
            self.addDirectoryItem(32625, 'podcastOne&podcastlist=featured-podcasts', 'diamond_is_a_cunt.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem(32626, 'podcastOne&podcastlist=new-podcasts', 'diamond_is_a_cunt.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem(32627, 'podcastOne&podcastcategories=list', 'diamond_is_a_cunt.png', 'DefaultVideoPlaylists.png')       
