...
class navigator:
    ...
    def kidsmovies(self, lite=False):       
        ...
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Kids Trending[/COLOR]', 'movies&url=ultimate', 'kids_trending.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Animated Movies[/COLOR]', 'movies&url=top', 'kids_animated.png', 'DefaultMovies.png')
        ...
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Dreamworks[/COLOR]', 'movies&url=dreamworks', 'kids_dreamworks.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Just Lego[/COLOR]', 'movies&url=lego', 'kids_lego.png', 'DefaultMovies.png')
        ...
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Gamers[/COLOR]', 'movies&url=gamers', 'kids_gamers.png', 'DefaultMovies.png')
    ...
    def random(self, lite=False):
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Disney Animation[/COLOR]', 'random&rtype=movie&url=disneycollection', 'kids_random.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Disney Pixar[/COLOR]', 'random&rtype=movie&url=disneypixar', 'kids_random.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Dreamworks[/COLOR]', 'random&rtype=movie&url=dreamworks', 'kids_random.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Superheroes[/COLOR]', 'random&rtype=movie&url=superheromovies', 'kids_random.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Family Movies[/COLOR]', 'random&rtype=movie&url=ultimate', 'kids_random.png', 'DefaultRecentlyAddedMovies.png')
                
        self.endDirectory()
        
    def kidsboxsets(self, lite=False):
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]3 Ninjas[/COLOR] [COLOR deepskyblue] (1992-1998)[/COLOR]', 'kidsboxsets&url=ninja', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]101 Dalmations[/COLOR] [COLOR deepskyblue] (1968-2003)[/COLOR]', 'collections&url=onehundredonedalmations', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]A Goofy Movie[/COLOR] [COLOR deepskyblue] (1995-2000)[/COLOR]', 'kidsboxsets&url=goofy', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Aladdin[/COLOR] [COLOR deepskyblue] (1992-1996)[/COLOR]', 'collections&url=aladdin', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Alvin and the Chipmunks[/COLOR] [COLOR deepskyblue] (1987-2015)[/COLOR]', 'kidsboxsets&url=alvin', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Angry Birds[/COLOR] [COLOR deepskyblue] (2016-2019)[/COLOR]', 'kidsboxsets&url=birds', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Atlantis[/COLOR] [COLOR deepskyblue] (2001-2003)[/COLOR]', 'kidsboxsets&url=atlantis', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Babe[/COLOR] [COLOR deepskyblue] (1995-1998)[/COLOR]', 'collections&url=babe', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Back to the Future[/COLOR] [COLOR deepskyblue] (1985-1990)[/COLOR]', 'kidsboxsets&url=future', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Beauty and the Beast[/COLOR] [COLOR deepskyblue] (1991-2017)[/COLOR]', 'collections&url=beautyandthebeast', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Beethoven[/COLOR] [COLOR deepskyblue] (1992-2014)[/COLOR]', 'collections&url=beethoven', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Brother Bear[/COLOR] [COLOR deepskyblue] (2003-2006)[/COLOR]', 'kidsboxsets&url=bear', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Cars[/COLOR] [COLOR deepskyblue] (2006-2017)[/COLOR]', 'kidsboxsets&url=cars', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Chronicles of Narnia[/COLOR] [COLOR deepskyblue] (2005-2010)[/COLOR]', 'kidsboxsets&url=narnia', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Cinderella[/COLOR] [COLOR deepskyblue] (1950-2007)[/COLOR]', 'kidsboxsets&url=cinderella', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Cloudy with a Chance of Meatballs[/COLOR] [COLOR deepskyblue] (2009-2013)[/COLOR]', 'kidsboxsets&url=cloudy', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Despicable Me[/COLOR] [COLOR deepskyblue] (2010-2017)[/COLOR]', 'kidsboxsets&url=despicable', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Diary of a Wimpy Kid[/COLOR] [COLOR deepskyblue] (2010-2017)[/COLOR]', 'kidsboxsets&url=wimpy', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Emperors New Groove[/COLOR] [COLOR deepskyblue] (2000-2005)[/COLOR]', 'kidsboxsets&url=emperor', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Fantastic Beasts[/COLOR] [COLOR deepskyblue] (2016-2018)[/COLOR]', 'kidsboxsets&url=beasts', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Finding Nemo[/COLOR] [COLOR deepskyblue] (2003-2016)[/COLOR]', 'kidsboxsets&url=nemo', 'kids_boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Fox and the Hound[/COLOR] [COLOR deepskyblue] (1981-2006)[/COLOR]', 'collections&url=foxandthehound', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Free Willy[/COLOR] [COLOR deepskyblue] (1993-2010)[/COLOR]', 'collections&url=freewilly', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Frozen[/COLOR] [COLOR deepskyblue] (2013-2019)[/COLOR]', 'kidsboxsets&url=frozen', 'kids_boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Ghostbusters[/COLOR] [COLOR deepskyblue] (1984-2016)[/COLOR]', 'kidsboxsets&url=ghostbusters', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Gremlins[/COLOR] [COLOR deepskyblue] (1984-1990)[/COLOR]', 'collections&url=gremlins', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]G.I. Joe[/COLOR] [COLOR deepskyblue] (2009-2013)[/COLOR]', 'kidsboxsets&url=gijoe', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Gnomeo & Juliet[/COLOR] [COLOR deepskyblue] (2011-2018)[/COLOR]', 'kidsboxsets&url=gnomes', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Goosebumps[/COLOR] [COLOR deepskyblue] (2015-2018)[/COLOR]', 'kidsboxsets&url=goosebumps', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Happy Feet[/COLOR] [COLOR deepskyblue] (2006-2011)[/COLOR]', 'kidsboxsets&url=feet', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Harry Potter[/COLOR] [COLOR deepskyblue] (2001-2009)[/COLOR]', 'kidsboxsets&url=harry', 'kids_boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Home Alone[/COLOR] [COLOR deepskyblue] (1990-2012)[/COLOR]', 'collections&url=homealone', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Honey, I Shrunk the Kids[/COLOR] [COLOR deepskyblue] (1989-1997)[/COLOR]', 'kidsboxsets&url=shrunk', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Hoodwinked[/COLOR] [COLOR deepskyblue] (2005-2011)[/COLOR]', 'kidsboxsets&url=hoodwinked', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Hotel Transylvania[/COLOR] [COLOR deepskyblue] (2012-2018)[/COLOR]', 'kidsboxsets&url=transylvania', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]How to Train Your Dragon[/COLOR] [COLOR deepskyblue] (2010-2019)[/COLOR]', 'kidsboxsets&url=dragon', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Hunchback of Notre Dame[/COLOR] [COLOR deepskyblue] (1996-2002)[/COLOR]', 'collections&url=hunchbackofnotredame', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Ice Age[/COLOR] [COLOR deepskyblue] (2002-2016)[/COLOR]', 'kidsboxsets&url=ice', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Jurassic Park[/COLOR] [COLOR deepskyblue] (1993-2018)[/COLOR]', 'kidsboxsets&url=jurassic', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Kung Fu Panda[/COLOR] [COLOR deepskyblue] (2008-2016)[/COLOR]', 'kidsboxsets&url=panda', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Lady and the Tramp[/COLOR] [COLOR deepskyblue] (1955-2001)[/COLOR]', 'kidsboxsets&url=lady', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Lilo & Stitch[/COLOR] [COLOR deepskyblue] (2002-2005)[/COLOR]', 'kidsboxsets&url=lilo', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Madagascar[/COLOR] [COLOR deepskyblue] (2005-2014)[/COLOR]', 'kidsboxsets&url=mad', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Men in Black[/COLOR] [COLOR deepskyblue] (1997-2019)[/COLOR]', 'kidsboxsets&url=mib', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Minions[/COLOR] [COLOR deepskyblue] (2015-2020)[/COLOR]', 'kidsboxsets&url=minions', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Monsters, inc.[/COLOR] [COLOR deepskyblue] (2001-2013)[/COLOR]', 'kidsboxsets&url=monsters', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Mulan[/COLOR] [COLOR deepskyblue] (1998-2004)[/COLOR]', 'collections&url=mulan', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Nanny McPhee[/COLOR] [COLOR deepskyblue] (2005-2010)[/COLOR]', 'kidsboxsets&url=nanny', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Narnia[/COLOR] [COLOR deepskyblue] (2005-2010)[/COLOR]', 'collections&url=narnia', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]New Groove[/COLOR] [COLOR deepskyblue] (2000-2005)[/COLOR]', 'collections&url=newgroove', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Night at the Museum[/COLOR] [COLOR deepskyblue] (2006-2014)[/COLOR]', 'kidsboxsets&url=museum', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Nut Job[/COLOR] [COLOR deepskyblue] (2014-2017)[/COLOR]', 'kidsboxsets&url=nut', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Open Season[/COLOR] [COLOR deepskyblue] (2006-2015)[/COLOR]', 'kidsboxsets&url=open', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Paddington Bear[/COLOR] [COLOR deepskyblue] (2014-2017)[/COLOR]', 'kidsboxsets&url=padd', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Percy Jackson[/COLOR] [COLOR deepskyblue] (2010-2013)[/COLOR]', 'kidsboxsets&url=percy', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Pirates of the Caribbean[/COLOR] [COLOR deepskyblue] (2003-2017)[/COLOR]', 'kidsboxsets&url=pirates', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Planes[/COLOR] [COLOR deepskyblue] (2013-2014)[/COLOR]', 'kidsboxsets&url=planes', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Pocahontas[/COLOR] [COLOR deepskyblue] (1995-1998)[/COLOR]', 'collections&url=pocahontas', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Pokémon[/COLOR] [COLOR deepskyblue] (1998-2019)[/COLOR]', 'kidsboxsets&url=pokemon', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Problem Child[/COLOR] [COLOR deepskyblue] (1990-1995)[/COLOR]', 'collections&url=problemchild', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Rio[/COLOR] [COLOR deepskyblue] (2011-2014)[/COLOR]', 'kidsboxsets&url=rio', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Sammys Adventures[/COLOR] [COLOR deepskyblue] (2010-2012)[/COLOR]', 'collections&url=sammysadventures', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Scooby-Doo[/COLOR] [COLOR deepskyblue] (2002-2014)[/COLOR]', 'collections&url=scoobydoo', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Short Circuit[/COLOR] [COLOR deepskyblue] (1986-1988)[/COLOR]', 'collections&url=shortcircuit', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png') 
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Shaun the Sheep[/COLOR] [COLOR deepskyblue] (2015-2019)[/COLOR]', 'kidsboxsets&url=sheep', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Shrek[/COLOR] [COLOR deepskyblue] (2001-2010)[/COLOR]', 'kidsboxsets&url=shrek', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Smurfs[/COLOR] [COLOR deepskyblue] (2011-2017)[/COLOR]', 'kidsboxsets&url=smurf', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]SpongeBob SquarePants[/COLOR] [COLOR deepskyblue] (2004-2017)[/COLOR]', 'collections&url=spongebobsquarepants', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Spy Kids[/COLOR] [COLOR deepskyblue] (2001-2011)[/COLOR]', 'collections&url=spykids', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Star Wars[/COLOR] [COLOR deepskyblue] (1977-2018)[/COLOR]', 'kidsboxsets&url=starwars', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Stuart Little[/COLOR] [COLOR deepskyblue] (1999-2002)[/COLOR]', 'collections&url=stuartlittle', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Surfs Up[/COLOR] [COLOR deepskyblue] (2007-2017)[/COLOR]', 'kidsboxsets&url=surf', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Tarzan[/COLOR] [COLOR deepskyblue] (1999-2002)[/COLOR]', 'kidsboxsets&url=tarzan', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Tinker Bell[/COLOR] [COLOR deepskyblue] (2007-2020)[/COLOR]', 'kidsboxsets&url=tinker', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Addams Family[/COLOR] [COLOR deepskyblue] (1991-1993)[/COLOR]', 'kidsboxsets&url=addams', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Flintstones[/COLOR] [COLOR deepskyblue] (1994-2000)[/COLOR]', 'kidsboxsets&url=flint', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Incredibles[/COLOR] [COLOR deepskyblue] (2004-2018)[/COLOR]', 'kidsboxsets&url=incredibles', 'kids_boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Jungle Book[/COLOR] [COLOR deepskyblue] (1967-2003)[/COLOR]', 'collections&url=thejunglebook', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Karate Kid[/COLOR] [COLOR deepskyblue] (1984-2010)[/COLOR]', 'collections&url=thekaratekid', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Land Before Time[/COLOR] [COLOR deepskyblue] (1988-2007)[/COLOR]', 'kidsboxsets&url=land', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Lion King[/COLOR] [COLOR deepskyblue] (1994-2019)[/COLOR]', 'kidsboxsets&url=king', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Little Mermaid[/COLOR] [COLOR deepskyblue] (1989-1995)[/COLOR]', 'collections&url=thelittlemermaid', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Mighty Ducks[/COLOR] [COLOR deepskyblue] (1992-1996)[/COLOR]', 'kidsboxsets&url=ducks', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Mummy[/COLOR] [COLOR deepskyblue] (1999-2017)[/COLOR]', 'kidsboxsets&url=mummy', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Neverending Story[/COLOR] [COLOR deepskyblue] (1984-1994)[/COLOR]', 'collections&url=theneverendingstory', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Secret Life of Pets[/COLOR] [COLOR deepskyblue] (2016-2019)[/COLOR]', 'kidsboxsets&url=pets', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]The Smurfs[/COLOR] [COLOR deepskyblue] (2011-2013)[/COLOR]', 'collections&url=thesmurfs', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Tooth Fairy[/COLOR] [COLOR deepskyblue] (2010-2012)[/COLOR]', 'collections&url=toothfairy', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]TMNT[/COLOR] [COLOR deepskyblue] (1978-2019)[/COLOR]', 'kidsboxsets&url=tmnt', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Tom and Jerry[/COLOR] [COLOR deepskyblue] (1992-2013)[/COLOR]', 'collections&url=tomandjerry', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Toy Story[/COLOR] [COLOR deepskyblue] (1995-2019)[/COLOR]', 'kidsboxsets&url=toystory', 'kids_boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Transformers[/COLOR] [COLOR deepskyblue] (1986-2017)[/COLOR]', 'kidsboxsets&url&url=robots', 'kids_boxsets.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]VeggieTales[/COLOR] [COLOR deepskyblue] (2002-2008)[/COLOR]', 'collections&url=veggietales', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Winnie the Pooh[/COLOR] [COLOR deepskyblue] (2000-2005)[/COLOR]', 'collections&url=winniethepooh', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Wizard of Oz[/COLOR] [COLOR deepskyblue] (1939-2013)[/COLOR]', 'collections&url=wizardofoz', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Wreck it Ralph[/COLOR] [COLOR deepskyblue] (2012-2018)[/COLOR]', 'kidsboxsets&url=ralph', 'kids_boxsets.png', 'DefaultRecentlyAddedMovies.png')
        
        self.endDirectory()

    def waltdisney(self, lite=False):
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Disney Pixar[/COLOR]', 'movies&url=disneypixar', 'kids_disney2.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Disney Nature[/COLOR]', 'movies&url=disneynature', 'kids_disney2.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Disney Animation[/COLOR]', 'movies&url=disneycollection', 'kids_disney2.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Disney Live Action[/COLOR]', 'movies&url=disneyliveaction', 'kids_disney2.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def superhero(self, lite=False):
        ...
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]DC vs Marvel[/COLOR]', 'movies&url=superheromovies', 'kids_dcvsmarvel.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Marvel Studios[/COLOR]', 'movies&url=marvelmovies', 'kids_marvel.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]DC Universe[/COLOR]', 'movies&url=dcmovies', 'kids_dc.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Marvel Animated[/COLOR]', 'movies&url=marvelanimate', 'kids_marvel3.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]DC Animated[/COLOR]', 'movies&url=dcanimate', 'kids_dc2.png', 'DefaultMovies.png')

        self.endDirectory()

    def kidstvshows(self, lite=False):
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Popular Cartoons[/COLOR]', 'tvshows&url=popularcartoons', 'kids_cartoons.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Trending Shows[/COLOR]', 'tvshows&url=viewsfamily', 'kids_trending.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Retro TV Series[/COLOR]', 'tvshows&url=retrotv', 'kids_retro.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Family TV Series[/COLOR]', 'tvshows&url=high', 'kids_family.png', 'DefaultTVShows.png')
        ...
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Popular Networks[/COLOR]', 'kidNetworks', 'kids_networks.png', 'DefaulTVShows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Marvel TV[/COLOR]', 'tvshows&url=marveltv', 'kids_marvel2.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Lego TV[/COLOR]', 'tvshows&url=lego', 'kids_lego2.png', 'DefaulTVShows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Transformers TV[/COLOR]', 'tvshows&url=robots', 'kids_transformers.png', 'DefaulTVShows.png')
        
        self.endDirectory()
    
    def toddlertv(self, lite=False):
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Disney Jr Shows[/COLOR]', 'tvshows&url=disneyjr', 'kids_youngsters2.png', 'DefaulTVShows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Nick Jr Shows[/COLOR]', 'tvshows&url=nickjr', 'kids_youngsters2.png', 'DefaulTVShows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Netflix Shows[/COLOR]', 'tvshows&url=netflixkid', 'kids_youngsters2.png', 'DefaulTVShows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Highly Rated[/COLOR]', 'tvshows&url=toddler', 'kids_youngsters2.png', 'DefaultTVShows.png')
    ...
    def teentv(self, lite=False):
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Freeform[/COLOR]', 'tvshows&url=freeform', 'kids_teen.png', 'DefualtTVshows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Nickelodeon[/COLOR]', 'tvshows&url=teennick', 'kids_teen.png', 'DefualtTVshows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Teen TV Shows[/COLOR]', 'tvshows&url=teentv', 'kids_teen.png', 'DefualtTVshows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Disney Channel[/COLOR]', 'tvshows&url=disneychannel', 'kids_teen.png', 'DefaulTVShows.png')
                
        self.endDirectory()

    def kidnetworks(self, lite=False):
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Nicktoons[/COLOR]', 'tvshows&url=nicktoons', 'kids_networks.png', 'DefualtTVshows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Disney XD[/COLOR]', 'tvshows&url=disneyxd', 'kids_networks.png', 'DefualtTVshows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Nickelodeon[/COLOR]', 'tvshows&url=nick', 'kids_networks.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Cartoon Network[/COLOR]', 'tvshows&url=cartoonnetwork', 'kids_networks.png', 'DefualtTVshows.png')

        self.endDirectory()

    def animemovies(self, lite=False):
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Trending Anime[/COLOR]', 'movies&url=animetrending', 'kids_anime.png', 'Defaultanimemovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Highly Rated[/COLOR]', 'movies&url=animehighlyrated', 'kids_anime.png', 'DefaultMovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Restricted Rated[/COLOR]', 'movies&url=animegrownup', 'kids_anime.png', 'Defaultanimemovies.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Top Anime Movies[/COLOR]', 'movies&url=animetopmovies', 'kids_anime.png', 'Defaultanimemovies.png')
    ...
    def animetvshows(self, lite=False):
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Trending Anime[/COLOR]', 'tvshows&url=animetrending', 'kids_anime2.png', 'playlist.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Highly Rated[/COLOR]', 'tvshows&url=animehighlyrated', 'kids_anime2.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Popular Anime[/COLOR]', 'tvshows&url=animepop', 'kids_anime2.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]People Watching[/COLOR]', 'tvshows&url=animepeoplewatching', 'kids_anime2.png', 'DefaultTVShows.png')
        self.addDirectoryItem('[B][COLOR deepskyblue]• [/COLOR][/B][COLOR ghostwhite]Top Anime Series[/COLOR]', 'tvshows&url=animetopseries', 'kids_anime2.png', 'DefaultTVShows.png')
