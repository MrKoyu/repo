...
class movies:
    def __init__(self):
        ...
        self.traktlikedlists_link = 'http://api.trakt.tv/users/likes/lists?limit=1000000'   #https://www.imdb.com/list/ls026580005/?sort=release_date,desc&st_dt=&mode=detail&page=1
