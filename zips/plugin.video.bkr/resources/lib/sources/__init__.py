...
class sources:
    ...
    def getSources(self, title, year, imdb, tvdb, season, episode, tvshowtitle, premiered, presetDict=[], timeout=30):
        ...
        progressDialog.update(0, 'Searching Sources...')
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.eden.container.items'

        self.metaProperty = 'plugin.video.eden.container.meta'
