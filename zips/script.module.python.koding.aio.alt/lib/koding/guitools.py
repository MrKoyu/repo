...
koding_path = Physical_Path("special://home/addons/script.module.python.koding.aio.alt")
#----------------------------------------------------------------    
# TUTORIAL #
...
#----------------------------------------------------------------    
# TUTORIAL #
def Notify(title, message, duration=2000, icon='special://home/addons/script.module.python.koding.aio.alt/resources/update.png'):
    """
