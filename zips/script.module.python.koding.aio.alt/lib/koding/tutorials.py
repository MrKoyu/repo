...
py_path    = 'special://home/addons/script.module.python.koding.aio.alt/lib/koding'
...
# Check if an example code segment exists in the comments    
    if 'EXAMPLE CODE:' in raw_find:
        ...
        code = code.replace('script.module.python.koding.aio.alt','temp_replace_string')
        code = code.replace('koding.','').strip()
        code = code.replace('temp_replace_string','script.module.python.koding.aio.alt')
