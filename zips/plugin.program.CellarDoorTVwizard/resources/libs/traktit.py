...
ORDER          = ['elysium', 'placenta', 'genesis reborn', 'incursion', 'cerebro', 'salts', 'death streams', 'neptune rising', 'velocity', 'metalliq', 'meta', 'trakt']
...
TRAKTID = { 
	...
	'cerebro': {
		...
		'file'     : os.path.join(TRAKTFOLD, 'showboxarize2_trakt'),
